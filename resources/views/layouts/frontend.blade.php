...
<html lang="en">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <!-- <div class="loader_bg">
         <div class="loader"><img src="{{asset('frontend/images/3.jpg')}}" alt="#" /></div>
      </div> -->
      <!-- end loader -->
      <!-- header -->
      <header>
                           ...
                           <div class="col-md-9">
                              <div class="row">
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                    <label style="color: black"><b>Jurusan</b></label>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                   <label style="color: black"><b>Kelas</b></label>
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                   <label style="color: black" style="font-size: 10%"><b>Tanggal Berangkat</b></label>
                                    <input type="date" class="form-control" name="tgl" min="<?= date
                                    ('Y-m-d') ?>" value="<?= date('Y-m-d') ?>" >
                                 </div>
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                    <label style="color: black"><b>Jumlah Tiket</b></label>
