                            ...
                            <div class="panel-body">
                                <div class="table-responsive table-bordered">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $data->pesans->keretas->nama_KA}}-{{ $data->pesans->keretas->asal}}-{{ $data->pesans->keretas->tujuan}}-Rp.{{number_format($data->pesans->keretas->harga,2,",",",")}}</td>
                                            <td>{{ $data->nm_penumpang}}</td>
                                            <td>{{ $data->no_telp}}</td>
                                            <td>{{ $data->no_ktp}}</td>
                                            <td>Rp.{{number_format($data->pesans->total,2,",",",")}}</td>
                                            <td>
